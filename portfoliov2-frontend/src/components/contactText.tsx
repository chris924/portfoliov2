...
export default function ContactText({ animationFinished }: ContactTextProps) {
  return (
    <>
      {animationFinished && (
        <RevealOnScroll>
          <section className="flex flex-col md:flex-row w-full max-w-8xl mx-auto gap-16 py-12 mt-20">
            {/* Left Side */}
